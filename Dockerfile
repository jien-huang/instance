...
VOLUME ["/var/results", "/var/scripts"]
WORKDIR /var/scripts
ENTRYPOINT testcafe $BROWSER:headless $SCRIPT -r xunit:/var/results/report.xml,json:/var/results/report.json --video /var/results/
